...
# Create a method to look up the dictionary "d" for the given the "key"
def lookup(d, key):
    found = False
    for child in d:
...
# Run the following query to find the data from the tables
...
print("-------Output from the SQL Query--------")
