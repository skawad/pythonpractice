# In this program you will use a GeoLocation lookup API modelled after the Google API to look up 
# some universities and parse the returned data.
# Calling a JSON API
...
# You will get different results from the geojson and json endpoints so make sure you are using 
...
# Hint: The first seven characters of the place_id are "ChIJOZU ..."
...
while True:
    ...
    # enter the addresed entered above and store in dictionary
    parms = dict()
    parms['address'] = address
    if api_key is not False: parms['key'] = api_key

    #encode the parameters that are assigned after the serviceurl above
